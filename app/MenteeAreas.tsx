...
const MenteeAreas = () => {
    ...
    const [mentorshipAreas, setMentorshipAreas] = useState(""); // State for mentorship areas input

    const handleSignUp = async () => {
        if (!mentorshipAreas) {
            Alert.alert("Error", "Please enter your areas of expertise.");
            return;
        }
        ...
        try {
            ...
            const mentorshipAreasArray = mentorshipAreas.split(",").map(area => area.trim());
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>
                Please list your areas of mentorship, separated by commas
            </Text>
